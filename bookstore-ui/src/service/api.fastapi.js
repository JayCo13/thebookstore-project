...
class ApiService {
   ...
   * Returns { order_id, payos_order_code, checkout_url, payment_link_id, qr_code, amount }.
   * Browser should navigate to `checkout_url`.
   */
  async createPayOSLink(orderId) {
    return this.client.post('/payments/payos/create-link', { order_id: orderId });
  }
...
// Payments
export const createPayOSLink = (...args) => apiService.createPayOSLink(...args);
